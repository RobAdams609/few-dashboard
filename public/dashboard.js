...
async function refreshCalls(){
  // We still pull Ringy for safety/team sums; but roster will prefer overrides.
  ...
  if (hasOverride){
    for (const a of STATE.roster){
      ...
      byKey.set(agentKey(a), {
        ...
        loggedMin: Number(o.loggedMin||0)  // NEW: logged minutes
      });
    }
    ...
    // No override? keep the Ringy team sums; roster per-agent stays empty here.
